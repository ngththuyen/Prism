...
class Settings(BaseSettings):
    ...
    reasoning_model: str = "gemini-1.5-flash"    # For text/chat
    multimodal_model: str = "gemini-1.5-flash" # For image/video analysis, consider "gemini-pro-vision" or "gemini-1.5-pro"
